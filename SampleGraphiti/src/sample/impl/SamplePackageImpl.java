...
public class SamplePackageImpl extends EPackageImpl implements SamplePackage {
	 ...
	 * @generated
	 */
	public EAttribute getPerson_EmployeeId() {
	 ...
	 * @generated
	 */
	public EReference getHierarchy_Manager() {
	 ...
	 * @generated
	 */
	public EReference getHierarchy_Reportee() {
	...
	public void createPackageContents() {
		...
		createEAttribute(personEClass, PERSON__EMPLOYEE_ID);
		createEAttribute(personEClass, PERSON__NAME);

		hierarchyEClass = createEClass(HIERARCHY);
		createEReference(hierarchyEClass, HIERARCHY__MANAGER);
		createEReference(hierarchyEClass, HIERARCHY__REPORTEE);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPerson_EmployeeId(), ecorePackage.getEDoubleObject(), "employeeId", null, 0, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getHierarchy_Manager(), this.getPerson(), null, "Manager", null, 1, 1, Hierarchy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHierarchy_Reportee(), this.getPerson(), null, "Reportee", null, 1, 1, Hierarchy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
